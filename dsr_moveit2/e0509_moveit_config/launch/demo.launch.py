...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("e0509")
        .robot_description(file_path="config/e0509.urdf.xacro")
    ...
    rviz_base = os.path.join(
        get_package_share_directory("e0509_moveit_config"), "launch"
    )
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("e0509_moveit_config"),
        "config",
