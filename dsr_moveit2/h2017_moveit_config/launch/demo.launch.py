...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("h2017")
        .robot_description(file_path="config/h2017.urdf.xacro")
    ...
    rviz_base = os.path.join(
        get_package_share_directory("h2017_moveit_config"), "launch"
    )
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("h2017_moveit_config"),
        "config",
