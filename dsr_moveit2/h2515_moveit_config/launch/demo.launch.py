...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder("h2515")
        .robot_description(file_path="config/h2515.urdf.xacro")
    ...
    rviz_base = os.path.join(
        get_package_share_directory("h2515_moveit_config"), "launch"
    )
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("h2515_moveit_config"),
        "config",
